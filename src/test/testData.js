...
const reservations = [
  {
    id: '12345',
    restaurantId: '123',
    userId: 'nKQjYf1RcqcGLnKugMuCN1TE7HE2', // replace these userIds with your own
  ...
  },
  {
    id: '12346',
    restaurantId: '345',
    userId: 'nKQjYf1RcqcGLnKugMuCN1TE7HE2',
...
const reviews = [
  {
    ...
    userId: 'nKQjYf1RcqcGLnKugMuCN1TE7HE2',
    rating: 4.0,
    // replace the "restaurant-app-demo-77bba" with the app id you choose during setup. These links won't
    // point to anything until we upload these files to Cloud Storage.
    photoUrls: [
      'https://storage.googleapis.com/restaurant-app-demo-77bba.appspot.com/reviewPhotos/hemingways-review-1.jpeg',
    ],
    text: `
...
const restaurants = [
  {
    ...
    name: "Hemingway's",
    imageUrl:
      'https://storage.googleapis.com/restaurant-app-demo-77bba.appspot.com/restaurants/hemingways.jpeg',
    rating: 4.0,
    address: {
  ...
  },
  {
    ...
    name: "Ben's Burgers",
    imageUrl:
      'https://storage.googleapis.com/restaurant-app-demo-77bba.appspot.com/restaurants/bens-burgers.jpeg',
    rating: 3.5,
    address: {
  ...
  },
  {
    ...
    name: 'Le Mollusc',
    imageUrl:
      'https://storage.googleapis.com/restaurant-app-demo-77bba.appspot.com/restaurants/le-mollusc.jpeg',
    rating: 4.5,
    address: {
